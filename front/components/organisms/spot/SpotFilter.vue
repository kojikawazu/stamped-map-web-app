  ...
  <div class="space-y-2.5">
    ...
    <div class="relative">
      ...
      <input
        ...
        class="w-full rounded-xl border border-slate-200 bg-slate-50 py-1.5 pr-8 pl-8 text-sm transition-all duration-150 placeholder:text-slate-400 focus:border-[#B8E0C4] focus:bg-white focus:ring-2 focus:ring-[#C8EDD4] focus:outline-none"
        @input="onSearchInput"
      />
      <button
        v-if="searchQuery"
    ...
    <div class="relative">
      <select
        :value="sortValue"
        class="w-full appearance-none rounded-xl border border-slate-200 bg-slate-50 px-3 py-1.5 pr-8 text-sm text-slate-700 transition-all duration-150 focus:border-[#B8E0C4] focus:bg-white focus:ring-2 focus:ring-[#C8EDD4] focus:outline-none"
        @change="onSortChange"
      >
    ...
    <div v-if="categories.length > 0" class="flex flex-wrap gap-1.5">
      <button
        ...
        :class="
          isSelected(cat.id)
            ? 'scale-105 border-transparent text-white shadow-sm'
